"""Train DANN on the 3 hp to 2 hp gap split."""
...
def main() -> None:
    ...
    for epoch in range(1, training_config["epochs"] + 1):
        ...
        val_loss, val_acc, val_f1 = evaluate_source(model, source_val_loader, class_criterion, device)
        total_loss, class_loss, domain_loss, source_acc, source_f1, domain_acc = metrics
        rows.append(
            {
                "epoch": epoch,
                ...
                "source_train_accuracy": source_acc,
                "source_train_macro_f1": source_f1,
        ...
        print(
            ...
            f"domain_loss={domain_loss:.6f} source_train_acc={source_acc:.6f} "
            f"source_train_f1={source_f1:.6f} domain_acc={domain_acc:.6f} | "
