"""Build fixed-length windows from CWRU raw DE signals and save them as a processed npz file."""
...
OUTPUT_PATH = PROJECT_ROOT / "data/processed/cwru_12k_de_windows.npz"
WINDOW_SIZE = 1024
STRIDE = 512
NORMALIZE = True
